...
<h4> 4. 당신의 얼굴에서 풍기는 인상은 어느 것에 가깝습니까? </h4>   
    ...
    <h4>7. 대인관계에서 당신은 다음 중 어느 쪽에 가깝습니까?</h4>       
     &nbsp; <td><input type=radio name = relationship></td> 
    ① 성질이 모나지 않고 유순하며 다투기를 싫어한다. 
     <br>&nbsp; <td><input type=radio name = relationship></td> 
    ...
    &nbsp; <td><input type=radio name = processing></td> 
     ① 내가 옳다고 생각하면 물러서지 않고 밀어붙인다. 
     <br>&nbsp; <td><input type=radio name = processing></td> 
    ...
    &nbsp; <td><input type=radio name = Disadvantages1></td> 
    ① 변화를 받아들이기가 겁난다.
     <br>&nbsp; <td><input type=radio name = Disadvantages1></td> 
    ② 겉으로는 화려하나 내실이 없다.
     <br>&nbsp; <td><input type=radio name = Disadvantages1></td> 
    ③ 너무 자기 멋대로만 하는 편이다. 
    <br>&nbsp; <td><input type=radio name = Disadvantages1></td> 
    ...
    <h4>10. 남의 일에도 자기 일처럼 잘 나서는 편이다. </h4>   
     &nbsp; <td><input type=radio name = yes|no1></td> 
    ① 예
    &nbsp; <td><input type=radio name = yes|no1></td> 
    ② 아니요
    
    <h4>11. 당신은 어느 쪽에 가깝습니까?</h4>
     &nbsp; <td><input type=radio name = type2></td> 
    ① 사람을 사귐에 있어 붙임성이 좋은 편이다. 
     <br>&nbsp; <td><input type=radio name = type2></td> 
    ② 붙임성이 없어서 사람을 사귀기가 힘들다. 
   
    
    <h4>12. 옳다고 생각하면 손해보는 것도 마다하지 않는다. </h4>   
     &nbsp; <td><input type=radio name = yes|no2></td> 
    ① 예
    &nbsp; <td><input type=radio name = yes|no2></td> 
    ② 아니요
    
    <h4>13. 남에게 자기의 속내를 잘 드러내지 않는다. </h3>
     &nbsp; <td><input type=radio name = yes|no3></td> 
    ① 예
     &nbsp; <td><input type=radio name = yes|no2></td> 
    ② 아니요
   
    <h4>14. 당신은 어느 쪽에 가깝습니까? </h4>
     &nbsp; <td><input type=radio name = type3></td> 
    ① 감정 표현이 다소 느리고 우회적이다. 
     <br>&nbsp; <td><input type=radio name = type3></td> 
    ② 감정 표현이 다소 즉각적이고 직설적이다. 
    
    <h4>15. 당신은 어느 쪽에 가깝습니까?    </h4>
     &nbsp; <td><input type=radio name = type4></td> 
    ① 생각보다 말이나 행동이 먼저 나가는 경우가 많다. 
    <br>&nbsp; <td><input type=radio name = type4></td> 
    ② 생각하는 습관 때문에 말 행동 할 기회를 놓치는 경우가 많다 
    
    <h4>16. 평소의 심리상태에서 다음 중 어느 쪽에 가깝습니까? </h3>
     &nbsp; <td><input type=radio name = Psychological></td> 
    ① 소심하고 마음이 불안정한 경우가 많다. 
     <br>&nbsp; <td><input type=radio name = Psychological></td> 
    ...
    <h4>17. 당신은 어느 쪽에 가깝습니까?</h4> 
     &nbsp; <td><input type=radio name = type5></td> 
    ① 남에게 싫은 소리를 잘 못한다.
     <br>&nbsp; <td><input type=radio name = type5></td> 
    ② 바른 소리를 잘 한다.
   
    <h4>18. 다음 중 당신은 어느 것에 가장 가깝습니까?  </h3>  
     &nbsp; <td><input type=radio name = type6></td> 
    ① 가만히 있는 것보다는 움직이는 것을 좋아한다. 
     <br>&nbsp; <td><input type=radio name = type6></td> 
    ② 움직이기를 싫어한다. 
     <br>&nbsp; <td><input type=radio name = type6></td> 
    ③ 밖으로 나돌아 다니기를 좋아하지 않는다. 
  
    <h4>19. 다음 중 당신은 어느 것에 가장 가깝습니까? </h3>  
     &nbsp; <td><input type=radio name = type7></td> 
    ① 평상시 체중변화가 많은 편이다. 
     <br>&nbsp; <td><input type=radio name = type7></td> 
    ② 체중 변화가 별로 없는 편이다. 
    
    <h4>20. 당신의 성격과 가장 가까운 것은?</h4>    
      &nbsp; <td><input type=radio name = character1></td> 
    ① 쾌활한
     <br>&nbsp; <td><input type=radio name = character1></td> 
    ② 평온한
     <br>&nbsp; <td><input type=radio name = character1></td> 
    ③ 몰두하는
     <br>&nbsp; <td><input type=radio name = character1></td> 
